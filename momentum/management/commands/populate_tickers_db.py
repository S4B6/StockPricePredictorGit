...
from momentum.models import Equity_Tickers, Bond_Tickers, Forex_Tickers, Cryptocurrency_Tickers, Commodity_Tickers
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        file_paths = {
            'bond': os.path.join(settings.BASE_DIR, 'momentum', 'tickers', 'bond_export.csv'),
            'commodity': os.path.join(settings.BASE_DIR, 'momentum', 'tickers', 'commodity_export.csv'),
            'cryptocurrency': os.path.join(settings.BASE_DIR, 'momentum', 'tickers', 'cryptocurrency_export.csv'),
            'equity': os.path.join(settings.BASE_DIR, 'momentum', 'tickers', 'equity_export.csv'),
            'forex': os.path.join(settings.BASE_DIR, 'momentum', 'tickers', 'forex_export.csv'),
        }
